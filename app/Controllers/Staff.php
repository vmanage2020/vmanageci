...
class STaff extends Controller {
	...
	public function email() 
	{
		...
		$message = "Dear ".$name."\n"."Thanks for submitted application."."\n"."Please pay application fee."."\n";

		$email = \Config\Services::email();

		$email->setFrom('info@akst.in', 'VManage School');
		$email->setTo('alagirivimal@gmail.com');
		$email->setCC('sasikala6644@gmail.com');
		$email->setBCC('akalagirivimal@gmail.com');

		$email->setSubject('Vmanage School Application');
	...
	public function createemail($data) 
	{
		...
		$name = $data['stu_prf_stud_name'];
		$email1 = $data['stu_prf_parent_email']; 
		$email2 = $data['stu_prf_stu_email'];
		...
		$email->setTo($email2);
		$email->setCC($email2);
		$email->setBCC('alagirivimal@gmail.com');
